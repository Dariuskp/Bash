...
#Notify of credentials creation
aws iam create-login-profile --user-name DioneP --password GoDawgs44! --password-reset-required 
aws iam create-login-profile --user-name DariusP --password RollTide21! --password-reset-required 
